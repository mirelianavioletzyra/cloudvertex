	...
	<header id="masthead" class="site-header">
		<div class="site-branding">
			...
			if ( $tailwind_description || is_customize_preview() ) :
				?>
				<p class="site-description"><?php echo $tailwind_description; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?></p>
			<?php endif; ?>
		</div><!-- .site-branding -->

		<nav id="site-navigation" class="main-navigation">
			<button class="menu-toggle" aria-controls="primary-menu" aria-expanded="false"><?php esc_html_e( 'Primary Menu', 'tailwind' ); ?></button>
			<?php
			wp_nav_menu(
				array(
