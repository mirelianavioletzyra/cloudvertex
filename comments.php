...
<div id="comments" class="comments-area grid grid-cols-12">

	<?php
	// You can start editing here -- including this comment!
	if (have_comments()) :
	?>
		<h2 class="comments-title col-span-8 col-start-3">
			<?php
		...
		<ol class="comment-list col-span-8 col-start-3">
			<?php
			wp_list_comments(
				array(
					'style'      => 'ol',
	...
	tailwind_modify_comment_form_markup();
	?>
